...
const ArticleDetailPage = () => {
  return (
    <main>
      <div className="mx-auto w-[880px] py-20">
        <div className="">
          ...
          <h1 className="mt-4 text-[32px] font-bold leading-10 text-gray-800">
            Thông báo Mã số dự thưởng Chương trình tri ân SeABank 30 năm: Kết nối vươn tầm - Khởi
            dựng hưng thịnh dành cho doanh nghiệp
          </h1>
          <div className="mb-6 mt-2 flex items-center justify-between text-sm text-[#4F4F4F]">
        ...
        {/* Article Content */}
        <div className="border-b border-b-[#EEEEEE] pb-8 text-gray-700">
        ...
        <div className="mb-10 mt-6 flex flex-wrap gap-3">
          <p className="text-base font-semibold">Từ khóa:</p>
          {[
            'Tin tức SeABank',
            ...
            <div key={tag} className="flex items-center gap-3">
              <span className="rounded-full bg-[#EEEEEE] px-4 py-2 text-sm font-medium">{tag}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-4 pb-20 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
          {[...Array(3)].map((_, index) => (
            <div key={index} className="mt-5 rounded-xl bg-[#F3F3F3] p-4">
              <CustomImage
              ...
              <p className="mt-[10px] line-clamp-3 text-sm text-[#828282]">
